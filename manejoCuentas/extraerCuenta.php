...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($monto <= 0) {
        ...
        // Preparar datos para enviar a sacar.php
        $postData = [
            'id' => $idCuenta,
            'monto' => $monto
        ];
        ...
        if ($resultado['success']) {
            // Redirigir a verCuenta.php si el retiro fue exitoso
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Retirar de Cuenta</h3>
                    </div>
                    <div class="card-body">
